namespace SistemasAnaliticos.Helpers
{
    public static class PlantillasEmail
    {
        ...
        public static string NotificacionRevisionGarantia(string nombreEmpleado, string nombreLicitacion)
        {
            return $@"
            <!DOCTYPE html>
            <html>
                        ...
                        <td align='center' style='padding: 40px 20px;'>
                            <table role='presentation' cellpadding='0' cellspacing='0' border='0' width='600' style='background-color: #ffffff; max-width: 600px;'>
                                ...
                                <tr>
                                    <td style='padding: 0 40px 20px 40px;'>
                                        <p style='margin: 0 0 20px 0; font-size: 16px; line-height: 1.5; color: #333333;'>
                                            A quien corresponda de revisión de garantías
                                        </p>
                                        <p style='margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #555555;'>
                                            Mediante la presente notificación, se informa que el empleado {nombreEmpleado} ha ingresado una nueva garantía por nombre <strong>{nombreLicitacion}</strong>, y actualmente se encuentra pendiente de revisión por su parte.
                                        </p>
                                        <p style='margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #555555;'>
                                            Si deseas observar más información, ingresa al sistema integral de SASA para consultar el detalle de la garantía.
                                        </p>
